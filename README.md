...
## 💡 What I Do
### Services
- **AI & Machine Learning**: Developing intelligent systems for practical applications
- **Database Design**: Crafting efficient and scalable database architectures
- **Back-End Programming**: Building robust and secure back-end systems
- **Software Development**: Creating impactful software solutions to solve real-world problems
...
![EC2](https://img.shields.io/badge/-AWS%20EC2-FF9900?logo=amazon-aws&logoColor=white)
![S3](https://img.shields.io/badge/-AWS%20S3-569A31?logo=amazon-s3&logoColor=white)
![RDS](https://img.shields.io/badge/-AWS%20RDS-232F3E?logo=amazon-aws&logoColor=white)
...
![AJAX](https://img.shields.io/badge/-AJAX-0078D7?logo=xml&logoColor=white)
...
## 📫 Let's Connect
- 💼 LinkedIn: [LinkedIn](https://www.linkedin.com/in/ayoub-azmi)
- 🌐 Website: [ayozmi.tech](https://ayozmi.tech)  
- ✉️ Email: [ayoub@azmi.ma](mailto:ayoub@azmi.ma)

---

Thank you for visiting my profile! Feel free to explore my repositories, and let's collaborate on exciting projects together. 😊
